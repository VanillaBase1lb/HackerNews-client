          ...
          <div className="flex flex-col">
            <div className="p-5 bg-white border-2 border-white shadow-sm hover:border-blue-400 transition rounded-lg my-2">
              <svg
                ...
                className="text-blue-500 mb-5 hi-outline hi-template inline-block w-12 h-12"
              >
                <path
                  strokeLinecap="round"
            ...
            <div className="p-5 bg-white border-2 border-white shadow-sm hover:border-blue-400 transition rounded-lg my-2">
              <svg
                ...
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="text-blue-500 mb-5 hi-outline hi-cube inline-block w-12 h-12"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <h4 className="text-lg font-bold mb-2">2. Self-Hosted Web App</h4>
              <p className="leading-relaxed text-gray-600">
            ...
            <div className="p-5 bg-white border-2 border-white shadow-sm hover:border-blue-400 transition rounded-lg sm:col-span-2 lg:col-span-1 my-2">
              <svg
                ...
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="text-blue-500 mb-5 hi-outline hi-cog inline-block w-12 h-12"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <h4 className="text-lg font-bold mb-2">3. Helper Tools</h4>
              <p className="leading-relaxed text-gray-600">
